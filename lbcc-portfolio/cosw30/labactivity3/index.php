<html>
  ...
  <body>
    ...
    <section id="customerInfo">
      <h2>Customer Info</h2>
    <p><input type="text" name="firstname" required> First Name</p>   
    <p><input type="text" name="lastname" required> Last Name</p>
    <p><input type="email" name="email" required> Email Address</p>
    <p><input type="tel" name="telephone" required> Phone Number</p>
    </section>
