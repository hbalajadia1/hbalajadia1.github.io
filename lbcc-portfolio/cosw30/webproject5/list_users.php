...
<?php
  ...
  if (isset($_GET['msg'])) {
    ...
    // $query = "select * from user " . $orderby . " limit " . $page_first_result . ',' . $results_per_page; 
    // $query = "select * from user";
    ...
    echo '<tr><th>User ID</th><th>First Name</th><th>' . '<a href=list_users.php?dir=asc>Last Name</a>' . '</th><th>Creation Date</th><th>Status</th><th>Actions</th></tr>';
