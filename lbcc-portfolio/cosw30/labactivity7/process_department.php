...
$query = "INSERT INTO `department` (`department_name`, `num_of_employees`, `building_name`, `status`) VALUES ('$department_name', '$num_of_employees', '$building_name', '$status')";
    ...
    echo "<p>Return to the <a href=\"\labactivity7\add_department.php\">department registration</a> page.</p>";
    echo "<p>Return to the <a href=\"\labactivity7\list_departments.php\">list of departments</a> page.</p>";
