...
if ($password == $confirmedpassword) {
    ...
    echo "<p>Return to the <a href=\"\webproject5\user_registration.php\">user registration</a> page.</p>";
} else {
   echo "<p>Your password does not match in both fields. <a href=\"\webproject5\user_registration.php\">Try again</a></p>\n";
}
?>
</html>